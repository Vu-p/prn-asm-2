        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NewsArticles_Accounts_CreatedById",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { (short)1, "staff@FUNewsManagementSystem.org", "Default Staff", "staff123", 1 },
                    { (short)2, "lecturer@FUNewsManagementSystem.org", "Default Lecturer", "lecturer123", 2 }
                });
